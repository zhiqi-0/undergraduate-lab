...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\2\2\2\f\r\f\5\2\2\r\16\7\5\2\2\16\23\5\4\3\6\17\20\f")
        buf.write("\4\2\2\20\21\7\4\2\2\21\23\5\4\3\5\22\f\3\2\2\2\22\17")
...
class MultFirstParser ( Parser ):
    ...
    class SContext(ParserRuleContext):
        ...
        def EOF(self):
            return self.getToken(MultFirstParser.EOF, 0)

        def getRuleIndex(self):
            return MultFirstParser.RULE_s
    ...
    def s(self):
        ...
        localctx = MultFirstParser.SContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.e(0)
            self.state = 5
            self.match(MultFirstParser.EOF)
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        ...
                        localctx = MultFirstParser.PlusContext(self, MultFirstParser.EContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_e)
                        self.state = 13
